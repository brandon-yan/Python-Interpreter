...
os.makedirs("temp")
for i in range(13):
    inst ="./build/python_interpreter testData/test"+str(i)+".in > temp/test"+str(i)+".out"
    print(inst)
    os.system(inst)
...
os.makedirs("temp")
for i in range(20):
    inst = "./build/python_interpreter BigIntegerTest/BigIntegerTest" + str(i) + ".in > temp/test" + str(i) + ".out"
    print(inst)
    os.system(inst)
